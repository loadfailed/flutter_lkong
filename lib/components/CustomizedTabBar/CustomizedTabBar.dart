...
/// See also:
///
///  * [CustomizedTabBar], which displays a row of tabs.
///  * [CustomizedTabBarView], which displays a widget for the currently selected tab.
///  * [CustomizedTabBar.indicator], which defines the appearance of the selected tab
///    indicator relative to the tab's bounds.
enum CustomizedTabBarIndicatorSize {
...
/// A material design [CustomizedTabBar] tab.
///
...
///  * [CustomizedTabBar], which displays a row of tabs.
///  * [CustomizedTabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [CustomizedTabBar] and a [CustomizedTabBarView].
///  * <https://material.io/design/components/tabs.html>
class CustomizedTab extends StatelessWidget {
  /// Creates a material design [CustomizedTabBar] tab.
  ///
...
double _indexChangeProgress(TabController controller) {
  ...
  // CustomizedTabBarView's PageView to the left or right.
...
class _IndicatorPainter extends CustomPainter {
  ...
  final CustomizedTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == CustomizedTabBarIndicatorSize.label) {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (controller.indexIsChanging) {
      ...
      // The user is dragging the CustomizedTabBarView's PageView left or right.
...
// This class, and CustomizedTabBarScrollController, only exist to handle the case
// where a scrollable CustomizedTabBar has a non-zero initialIndex. In that case we can
// only compute the scroll position's initial scroll offset (the "correct"
// pixels value) after the CustomizedTabBar viewport width and scroll limits are known.
class _CustomizedTabBarScrollPosition extends ScrollPositionWithSingleContext {
  _CustomizedTabBarScrollPosition({
  ...
  final _CustomizedTabBarState tabBar;
...
// This class, and CustomizedTabBarScrollPosition, only exist to handle the case
// where a scrollable CustomizedTabBar has a non-zero initialIndex.
class _CustomizedTabBarScrollController extends ScrollController {
  _CustomizedTabBarScrollController(this.tabBar);
  ...
  ScrollPosition createScrollPosition(ScrollPhysics physics,
    ...
    return _CustomizedTabBarScrollPosition(
      physics: physics,
      context: context,
      oldPosition: oldPosition,
      tabBar: tabBar,
...
/// conjunction with a [CustomizedTabBarView].
///
/// If a [TabController] is not provided, then a [DefaultTabController] ancestor
/// must be provided instead. The tab controller's [TabController.length] must
/// equal the length of the [tabs] list and the length of the
/// [CustomizedTabBarView.children] list.
///
/// Requires one of its ancestors to be a [Material] widget.
///
/// Uses values from [CustomizedTabBarTheme] if it is set in the current context.
///
/// To see a sample implementation, visit the [TabController] documentation.
///
/// See also:
///
///  * [CustomizedTabBarView], which displays page views that correspond to each tab.
class CustomizedTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the length of the [CustomizedTabBarView.children] list.
  ...
  /// and the entire [CustomizedTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// is [CustomizedTabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the tab in the tab bar. If [indicatorSize] is
  /// [CustomizedTabBarIndicatorSize.label], then the tab's bounds are only as wide as
  ...
  /// tab's overall bounds if [indicatorSize] is [CustomizedTabBarIndicatorSize.tab]
  /// (the default) or relative to the bounds of the tab's widget if
  /// [indicatorSize] is [CustomizedTabBarIndicatorSize.label].
  ///
  ...
  /// An optional callback that's called when the [CustomizedTabBar] is tapped.
  ///
  /// The callback is applied to the index of the tab where the tap occurred.
  ///
  /// This callback has no effect on the default handling of taps. It's for
  /// applications that want to do a little extra work when a tab is tapped,
  /// even if the tap doesn't change the TabController's index. CustomizedTabBar [onTap]
...
class _CustomizedTabBarState extends State<CustomizedTabBar> {
  ...
  // If the CustomizedTabBar is rebuilt with a new tab controller, the caller should
  ...
  @override
  void didUpdateWidget(CustomizedTabBar oldWidget) {
  ...
  void _handleTabControllerAnimationTick() {
    ...
    if (!_controller.indexIsChanging && widget.isScrollable) {
      // Sync the CustomizedTabBar's scroll position with the CustomizedTabBarView's PageView.
      _currentIndex = _controller.index;
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (_controller.length != widget.tabs.length) {
        throw FlutterError(
            ...
            'number of tabs (${widget.tabs.length}) present in CustomizedTabBar\'s tabs property.');
      }
      return true;
    }());
    ...
    if (widget.isScrollable) {
      _scrollController ??= _CustomizedTabBarScrollController(this);
...
/// selected tab.
///
/// This widget is typically used in conjunction with a [CustomizedTabBar].
///
/// If a [TabController] is not provided, then there must be a [DefaultTabController]
/// ancestor.
///
/// The tab controller's [TabController.length] must equal the length of the
/// [children] list and the length of the [CustomizedTabBar.tabs] list.
///
/// To see a sample implementation, visit the [TabController] documentation.
class CustomizedTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const CustomizedTabBarView({
    Key key,
  ...
  /// One widget per tab.
  ///
  /// Its length must match the length of the [CustomizedTabBar.tabs]
  ...
  @override
  _CustomizedTabBarViewState createState() => _CustomizedTabBarViewState();
}

final PageScrollPhysics _kCustomizedTabBarViewPhysics =
    const PageScrollPhysics().applyTo(const ClampingScrollPhysics());

class _CustomizedTabBarViewState extends State<CustomizedTabBarView> {
  TabController _controller;
  ...
  // If the CustomizedTabBarView is rebuilt with a new tab controller, the caller should
  // dispose the old one. In that case the old controller's animation will be
  // null and should not be accessed.
  bool get _controllerIsValid => _controller?.animation != null;
  ...
  @override
  void didUpdateWidget(CustomizedTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  Widget build(BuildContext context) {
    assert(() {
      if (_controller.length != widget.children.length) {
        throw FlutterError(
            'Controller\'s length property (${_controller.length}) does not match the \n'
            'number of tabs (${widget.children.length}) present in CustomizedTabBar\'s tabs property.');
      }
      return true;
    }());
    return NotificationListener<ScrollNotification>(
      ...
      child: PageView(
        ...
        physics: widget.physics == null
            ? _kCustomizedTabBarViewPhysics
            : _kCustomizedTabBarViewPhysics.applyTo(widget.physics),
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget _buildTabIndicator(
    ...
    if (tabController.indexIsChanging) {
      ...
      // The selection's offset reflects how far the CustomizedTabBarView has / been dragged
