...
/// app bar, see [SliverCustomizedAppBar], which embeds an [CustomizedAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///
/// The CustomizedAppBar displays the toolbar widgets, [leading], [title], and [actions],
...
///
/// This sample shows an [CustomizedAppBar] with two simple actions. The first action
...
///     key: scaffoldKey,
///     appBar: CustomizedAppBar(
///       title: const Text('CustomizedAppBar Demo'),
///       actions: <Widget>[
///         IconButton(
...
/// See also:
///
///  * [Scaffold], which displays the [CustomizedAppBar] in its [Scaffold.appBar] slot.
///  * [SliverCustomizedAppBar], which uses [CustomizedAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [CustomizedAppBar]
...
class CustomizedAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [actionsIconTheme], or [textTheme] are null, then their [CustomizedAppBarTheme]
  /// values will be used. If the corresponding [CustomizedAppBarTheme] property is null,
  ...
  /// [CustomizedAppBar] will imply an appropriate widget. For example, if the [CustomizedAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [CustomizedAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [CustomizedAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [CustomizedAppBar]'s container
  /// changes the [CustomizedAppBar]'s size. A [SliverCustomizedAppBar] in a [CustomScrollView]
  /// changes the [CustomizedAppBar]'s height when scrolled.
  ///
  ...
  /// used by [SliverCustomizedAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
    ...
    if (title != null) {
      ...
      title = DefaultTextStyle(
        ...
        child: Semantics(
          ...
          child: _CustomizedAppBarTitleBox(child: title),
          header: true,
        ),
      );
    }
...
class _FloatingCustomizedAppBar extends StatefulWidget {
  const _FloatingCustomizedAppBar({Key key, this.child}) : super(key: key);

  final Widget child;

  @override
  _FloatingCustomizedAppBarState createState() =>
      _FloatingCustomizedAppBarState();
}

// A wrapper for the widget created by _SliverCustomizedAppBarDelegate that starts and
// stops the floating app bar's snap-into-view or snap-out-of-view animation.
class _FloatingCustomizedAppBarState extends State<_FloatingCustomizedAppBar> {
...
class _SliverCustomizedAppBarDelegate extends SliverPersistentHeaderDelegate {
  _SliverCustomizedAppBarDelegate({
  ...
  Widget build(
    ...
    return floating ? _FloatingCustomizedAppBar(child: appBar) : appBar;
  }

  @override
  bool shouldRebuild(covariant _SliverCustomizedAppBarDelegate oldDelegate) {
...
/// the screen see [CustomizedAppBar], which is used in the [Scaffold.appBar] slot.
///
/// The CustomizedAppBar displays the toolbar widgets, [leading], [title], and
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverCustomizedAppBar] into its
///    scrolling.
///  * [CustomizedAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [CustomizedAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class SliverCustomizedAppBar extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const SliverCustomizedAppBar({
    Key key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [CustomizedAppBar] will
  /// imply an appropriate widget. For example, if the [CustomizedAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [CustomizedAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [CustomizedAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [CustomizedAppBar] is being displayed over content that is scrolled under it.
  ///
  ...
  /// See also:
  ///
  ///  * [SliverCustomizedAppBar] for more animated examples of how this property changes the
  ...
  @override
  _SliverCustomizedAppBarState createState() => _SliverCustomizedAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverCustomizedAppBarState extends State<SliverCustomizedAppBar>
  ...
  @override
  void didUpdateWidget(SliverCustomizedAppBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _SliverCustomizedAppBarDelegate(
...
// Layout the CustomizedAppBar's title with unconstrained height, vertically
// center it within its (NavigationToolbar) parent, and allow the
// parent to constrain the title's actual height.
class _CustomizedAppBarTitleBox extends SingleChildRenderObjectWidget {
  const _CustomizedAppBarTitleBox({Key key, @required Widget child})
      : assert(child != null),
        super(key: key, child: child);

  @override
  _RenderCustomizedAppBarTitleBox createRenderObject(BuildContext context) {
    return _RenderCustomizedAppBarTitleBox(
  ...
  void updateRenderObject(
      BuildContext context, _RenderCustomizedAppBarTitleBox renderObject) {
    renderObject.textDirection = Directionality.of(context);
  }
}

class _RenderCustomizedAppBarTitleBox extends RenderAligningShiftedBox {
  _RenderCustomizedAppBarTitleBox({
    RenderBox child,
